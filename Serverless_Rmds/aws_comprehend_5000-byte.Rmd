...
# Iterating through the chunks (Partial + Whole iteration)
for (i in 1:(full.iter+1)) { 
    ...
    if (five.thousand.byte.chunk[i] > "") {  
        ...
        # Extract sentiments chunk by chunk
