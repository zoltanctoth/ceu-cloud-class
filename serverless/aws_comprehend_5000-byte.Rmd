...
# Reading txt 
txtfile <- read_file("~/Documents/CEU/ECBS-5147-Data-Engineering-2-Big-Data-and-Cloud-Computing/serverless/alice_in_wonderland-english.txt")
...
five.thousand.byte.chunk <- char.segments(cleanedtext, 4500)
