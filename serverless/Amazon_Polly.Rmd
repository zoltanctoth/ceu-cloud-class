...
```{r}
# synthesize some text
vec3 <- synthesize("Forget that! There are places in this world that aren't made out of stone.", voice = "Matthew")
play(vec3)
```

```{r}
# synthesize some text
vec4 <- synthesize("Forget that! There are places in this world that aren't made out of stone. ", voice = "Salli")
play(vec4)
```
