...
# =============================================================================
# Docs: https://doc.wikimedia.org/generated-data-platform/aqs/analytics-api/reference/edits.html#list-most-edited-pages-by-number-of-edits # noqa: E501
# =============================================================================
...
# Solution:
s3_key = f"datalake/raw/raw-edits-{date.strftime('%Y-%m-%d')}.txt"
res = s3.upload_file(
    raw_edits_file,
    S3_WIKI_BUCKET,
    s3_key,
