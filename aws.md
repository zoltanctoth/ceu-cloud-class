...
- [Part 7 - Launching an EC2 Instance](#part-7---launching-an-ec2-instance)
  ...
  * [Practice Questions / Q&A](#practice-questions---q-a)
    + [What are the advantages of cloud computing?](#what-are-the-advantages-of-cloud-computing-)
    + [What are the types of cloud computing?](#what-are-the-types-of-cloud-computing-)
    + [What are the models of computing deployment?](#what-are-the-models-of-computing-deployment-)
    + [What is S3 and what does it mean?](#what-is-s3-and-what-does-it-mean-)
    + [What are some usages of S3?](#what-are-some-usages-of-s3-)
    + [What are the features of S3?](#what-are-the-features-of-s3-)
    + [What is AWS EC2?](#what-is-aws-ec2-)
    + [What is a region?](#what-is-a-region-)
    + [What is an Availability Zones ?](#what-is-an-availability-zones--)
    + [What is an Edge Location?](#what-is-an-edge-location-)
    + [What is the difference between a region, an Availability Zone and an Edge Location?](#what-is-the-difference-between-a-region--an-availability-zone-and-an-edge-location-)
    + [What is IAM?](#what-is-iam-)
    + [Critical terms of IAM?](#critical-terms-of-iam-)
    + [Is IAM Global?](#is-iam-global-)
    + [What is the root account?](#what-is-the-root-account-)
    + [Which permissions have new users when created?](#which-permissions-have-new-users-when-created-)
    + [What is the difference between access keys and user/pass?](#what-is-the-difference-between-access-keys-and-user-pass-)
    + [What is S3?](#what-is-s3-)
    + [Size of the files on S3?](#size-of-the-files-on-s3-)
    + [What is the data consistency model for S3?](#what-is-the-data-consistency-model-for-s3-)
    + [S3 is object based. What do objects consist of?](#s3-is-object-based-what-do-objects-consist-of-)
    + [What are the different Tiers/Classes of storage for S3?](#what-are-the-different-tiers-classes-of-storage-for-s3-)
    + [S3 Charges?](#s3-charges-)
    + [What is S3 Transfert Acceleration?](#what-is-s3-transfert-acceleration-)
    + [What are the server side encryption options for S3?](#what-are-the-server-side-encryption-options-for-s3-)
    + [What are the two options for controlling access to a S3 bucket?](#what-are-the-two-options-for-controlling-access-to-a-s3-bucket-)
    + [S3 Versioning characteristics?](#s3-versioning-characteristics-)
    + [Cross replication on S3?](#cross-replication-on-s3-)
    + [Lifecycle Management in S3?](#lifecycle-management-in-s3-)
    + [What are the two types of encryption on S3?](#what-are-the-two-types-of-encryption-on-s3-)
